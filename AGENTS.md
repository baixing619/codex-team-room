...
- A private Sites deployment and the local Codex bridge are separate trust zones. Never claim the hosted page can reach a user's local App Server unless an authenticated device-pairing transport has actually been implemented and verified.
